    ...
    return (
        <div className='flower-section'>
            ...
            <FlowerCard
                ...
                description="Son el símbolo de la pureza, la inocencia, la amistad incondicional y el amor puro desligado de aquellas connotaciones que apunten hacia pasiones o romances entre personas. Simbolizan la alegría, la sencillez, la sofisticación natural, sin ornamentos y manipulaciones, que ofrece la naturaleza."
            />
            <FlowerCard
